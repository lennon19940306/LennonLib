...
public class DateUtil {
     ...
     * @return
     */
    public static String StampToDate(String seconds, DateStyle format) {
     ...
     * @return
     */
    public static String DateToTimeStamp(String date_str, DateStyle format) {
        try {
            SimpleDateFormat sdf = new SimpleDateFormat(format.getValue());
     ...
     */
    public static boolean isDate2Bigger(Date endTime, Date startTime) {
        return isDate2Bigger(endTime, startTime, true);
    }

    public static boolean isDate2Bigger(Date endTime, Date startTime, boolean equals) {
        boolean isBigger;
