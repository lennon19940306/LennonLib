...
import com.lennon.zxing.ZxingPath;
 ...
 * @declare :扫一扫
 */
@Route(path = ZxingPath.Path)
public class CaptureActivity extends AppCompatActivity implements Capture, SurfaceHolder.Callback, View.OnClickListener {
